...
# ------------------------------------------------------------
# swing-jazz（DESIGN.md §6.6。EXT-1 スウィングの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# prog-rock（DESIGN.md §6.7。EXT-2 可変小節の実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# future-bass（DESIGN.md §6.9。EXT-4 サイドチェインの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# trap（DESIGN.md §6.8。EXT-1 サブステップ／EXT-5 808グライドの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# maqam（DESIGN.md §6.10。EXT-3 マイクロチューニングの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# free-jazz（DESIGN.md §6.11。EXT-5① テンポカーブの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# minimalism（DESIGN.md §6.12。EXT-2② ポリメトリックの実証ジャンル）
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# orchestral（DESIGN.md §6.13。EXT-6 マルチチャンネル/XM の実証ジャンル）
# ------------------------------------------------------------
