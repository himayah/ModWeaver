...
from ..profiles.band_common import (
    BandProfile, BassSpec, ChannelDef, LeadSpec, PadSpec, Section, buildup, hits, preset,
)
from ..profiles.registry import register_profile

C = ChordSpec
CH_KICK, CH_PERC, CH_BASS, CH_CHORD, CH_LEAD, CH_FX = range(6)
...
class EdmProfile(BandProfile):
    ...
    SECTIONS = {
        ...
        "drop": Section("drop", prog=0, intensity=1.0, parts=frozenset({"drums", "bass", "pad", "lead", "fx"})),
