...
C = ChordSpec
CH_KS, CH_HAT, CH_BASS, CH_KEYS, CH_LEAD, CH_PAD, CH_X_LEAD_ECHO, CH_X_STRINGS = range(8)   # 7・8 番目は 8ch の編成だけ
...
class PopProfile(BandProfile):
    ...
    ARRANGEMENTS = {                          # DESIGN.md §6.14: 4ch＝小編成、6ch＝標準、8ch＝任意パートを足す
        ...
        6: keep("kick/snare", "hat", "bass", "piano", "lead", "pad"),
        8: keep("kick/snare", "hat", "bass", "piano", "lead", "pad", "lead echo", "strings"),
    }
